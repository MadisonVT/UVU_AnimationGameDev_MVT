...
//Name: Cliff_Ball_Bounce_Anim.ma
//Last modified: Wed, Sep 09, 2026 12:52:38 AM
//Codeset: 1252
file -rdi 1 -ns "basicsBall_rig_v0_1_beta" -rfn "basicsBall_rig_v0_1_betaRN"
		 ...
		 -typ "mayaBinary" "C:/Users/madis/Documents/UVU/UVU_AnimationGameDev_MVT/MayaProject/3rdParty_Assets/basics_rig_v01_beta/basics_rig_v01_beta/basicsBall_rig_v0.1_beta.mb";
...
fileInfo "UUID" "C4CDC7E8-4A6B-83E3-459F-E99C3585CCFE";
createNode transform -s -n "persp";
	rename -uid "0F02864B-4AA3-37D0-F2BC-C9BEB573A654";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.7452978408504185 9.9223074055446716 68.65673537089539 ;
	setAttr ".r" -type "double3" -1.7999999999999989 -0.80000000000000016 0 ;
	setAttr ".rpt" -type "double3" 4.8172012421979866e-17 2.2695342711196351e-16 2.0349802331685444e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D754E234-4ACF-5F45-5E1C-B184A459B3BF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 68.950707192392585;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 7.4497557539093906 1.8062511532844603 0 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "FCA1582F-4A60-70D6-9239-CCB552A1291B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "5B3C9BE5-43A2-556D-140E-448442E56CD9";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "AC65B3BF-4C24-395D-2D85-C9AF7D34F16E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "EEA3DA00-4F93-6862-1908-018D14FEADC4";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "60CD4315-498C-2749-E2EB-6C8E36B27880";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "9261C5CE-40B6-C444-2999-28BAB032C269";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -n "pCube1";
	rename -uid "60ADCA31-4ED3-0AF7-6AA0-F38A9B1C2E25";
	setAttr ".t" -type "double3" 0 0.024052695124102463 0 ;
	setAttr ".s" -type "double3" 87.105161023970751 37.856718200806576 37.856718200806576 ;
	setAttr ".rp" -type "double3" 0 -0.016006529331207275 0 ;
	setAttr ".sp" -type "double3" 0 -0.016006529331207275 0 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	rename -uid "46522ACD-4C29-2C91-9FE8-758BC78E0AB3";
	setAttr -k off ".v";
	...
	setAttr -s 5 ".pt[0:4]" -type "float3"  0 0.48399347 0 0 0.48399347 
		0 0 0.48399347 0 0 0.48399347 0 0 0 0;
createNode transform -n "pCube2";
	rename -uid "1760E685-48CB-C588-88C0-0FAB2E5EC6BE";
	setAttr ".t" -type "double3" -12.387707645653377 4.6943136908050915 0 ;
	setAttr ".s" -type "double3" 12.393441102306786 11.194510026633562 6.6373263074606426 ;
createNode mesh -n "pCubeShape2" -p "pCube2";
	rename -uid "C5EE7415-4DD0-7E5A-8074-7C82C9C7211A";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "995CA2EE-43DD-EB82-F93E-5D9BE78AC65C";
	setAttr -s 22 ".lnk";
	setAttr -s 22 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C65F167F-4A97-8DA8-EF68-B78AC0526DD8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5EF602F9-4E97-F9EC-3AB9-AE8D9D63D6BC";
createNode displayLayerManager -n "layerManager";
	rename -uid "D6986A32-4BC5-FA50-D834-0B823D6D431A";
createNode displayLayer -n "defaultLayer";
	rename -uid "402E9557-4A97-171E-60A2-B68C71CCE9A7";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "00A00A0B-4D67-9263-FC8F-76A3E9A8216F";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "4E583890-421B-561C-E4DA-71A236C65DA9";
	setAttr ".g" yes;
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	rename -uid "894F34D6-4296-862D-1A59-BEB253E841A5";
	setAttr ".version" -type "string" "5.4.8.2";
createNode aiAOVFilter -s -n "defaultArnoldFilter";
	rename -uid "6E75528B-457A-D889-473A-2D83ACEDA5E1";
	setAttr ".ai_translator" -type "string" "gaussian";
createNode aiAOVDriver -s -n "defaultArnoldDriver";
	rename -uid "3EB0AF3C-49C7-22CF-0353-A39EF6398C32";
	setAttr ".ai_translator" -type "string" "exr";
createNode aiAOVDriver -s -n "defaultArnoldDisplayDriver";
	rename -uid "35BB2610-406C-C01C-2673-CB9E47FC2F43";
	setAttr ".ai_translator" -type "string" "maya";
	setAttr ".output_mode" 0;
createNode aiImagerDenoiserOidn -s -n "defaultArnoldDenoiser";
	rename -uid "743B1DB6-4646-F5F9-2359-4CA1D30DC2C3";
createNode script -n "uiConfigurationScriptNode";
	rename -uid "15BABEF5-4FD9-2A55-F79A-69B7FAEB20F3";
...
createNode script -n "sceneConfigurationScriptNode";
	rename -uid "24E237A9-415D-B0B9-0B06-B6AC6650F883";
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 24 -ast 0 -aet 24 ";
	setAttr ".st" 6;
createNode polyCube -n "polyCube1";
	rename -uid "083A8DFC-4CAF-FE63-06E6-378AE462DC57";
	setAttr ".cuv" 4;
createNode deleteComponent -n "deleteComponent1";
	rename -uid "1C5766B5-4CFE-AFDF-EFA8-C4B4486996CA";
	setAttr ".dc" -type "componentList" 1 "f[1]";
createNode deleteComponent -n "deleteComponent2";
	rename -uid "14A53537-4C70-85E0-FEE5-DF9F2BD083EE";
	setAttr ".dc" -type "componentList" 1 "f[0]";
createNode deleteComponent -n "deleteComponent3";
	rename -uid "1D9C3D10-4C52-C0DD-5231-FDAD09D46133";
	setAttr ".dc" -type "componentList" 1 "f[0]";
createNode deleteComponent -n "deleteComponent4";
	rename -uid "8244430B-4EB0-0866-15BD-358D69AC9FE8";
	setAttr ".dc" -type "componentList" 1 "f[2]";
createNode deleteComponent -n "deleteComponent5";
	rename -uid "28D051E3-4B03-7D78-C3CE-DFAC03A43F4E";
	setAttr ".dc" -type "componentList" 1 "f[1]";
createNode polyNormal -n "polyNormal1";
	rename -uid "40A4DE95-43FD-E2F1-332A-31A56B109CE3";
	setAttr ".ics" -type "componentList" 1 "f[0]";
	setAttr ".unm" no;
createNode shadingEngine -n "lambert1SG";
	rename -uid "9E8E61E6-40E8-2F14-0020-C6879F7DE750";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "CAF71519-4B78-ADAA-B1E1-C1948BC25A0E";
createNode groupId -n "groupId1";
	rename -uid "B9BD3D1D-4301-DF35-85E8-5E9560A017C8";
	setAttr ".ihi" 0;
createNode groupParts -n "groupParts1";
	rename -uid "B0E7B431-4983-1336-957F-F39AD38ABCF6";
	setAttr ".ihi" 0;
	setAttr ".ic" -type "componentList" 1 "f[0]";
createNode groupId -n "groupId2";
	rename -uid "5B8C2906-4AB1-8735-5A70-1C930E7E44CF";
	setAttr ".ihi" 0;
createNode polyCube -n "polyCube2";
	rename -uid "D0B809B5-4DB1-E25B-974F-7BA9937C249D";
	setAttr ".cuv" 4;
createNode reference -n "basicsBall_rig_v0_1_betaRN";
	rename -uid "653C5CAD-4050-0DDA-C9DD-5F8047B77EDF";
	setAttr -s 12 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
...
createNode animCurveTL -n "basicBall_ac_cn_base_translateX";
	rename -uid "A63408AC-4325-0B9D-9927-EDA8C8E6A0E8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -9.4540465824426825 4 -6.1589186923115653
		 8 -2.3790462925034346 12 2.3693761021201967 16 7.4497557539093906 19 12.869076432547356
		 22 17.974870019807337 24 20.231508692307759;
createNode animCurveTL -n "basicBall_ac_cn_base_translateY";
	rename -uid "01DC3597-4BDD-6469-87D9-E5A995C28589";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 10.31193682399236 4 10.326408817075269
		 8 0.30651001677526857 12 4.9637172040338724 16 0.25249648302732464 19 3.2246954673934489
		 22 -0.0039162934733241173;
createNode animCurveTL -n "basicBall_ac_cn_base_translateZ";
	rename -uid "76AB7A6C-4C76-7371-BC27-459BFDEDEF54";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTA -n "basicBall_ac_cn_base_rotateX";
	rename -uid "927DAF9B-4458-19BA-AFB7-E99ED68277CB";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTA -n "basicBall_ac_cn_base_rotateY";
	rename -uid "E2462452-436E-EDC6-A1E9-B7BB0D6A1C3D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTA -n "basicBall_ac_cn_base_rotateZ";
	rename -uid "0D3BBC21-416D-2510-B3DC-ABB563EE39DC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "basicBall_ac_cn_base_global_scale";
	rename -uid "D33CA251-4C57-F0F1-D3B6-C9868B7FD413";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 1;
createNode animCurveTU -n "basicBall_ac_cn_base_type_ball";
	rename -uid "95822CD0-4881-D05F-9F5D-199E6B7151FE";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 7;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "basicBall_ac_cn_top_translateX";
	rename -uid "B2BE342B-4F42-E943-3ABD-A281602AFD9C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 0 5 -0.33338775905697293 7 -0.87387240943103695
		 8 0 9 1.2905353529281332 12 0 15 -1.2363330199980123 16 0 17 1.8571362212614488 19 0
		 22 -1.1960636050713518 23 -0.31271795421364823 24 0;
	setAttr -s 13 ".kit[0:12]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18;
	setAttr -s 13 ".kot[0:12]"  1 1 18 18 18 18 18 18 
		18 18 18 18 18;
	setAttr -s 13 ".kix[0:12]"  0.26467209474590636 0.99437384504648896 
		1 0.038473173845893271 1 0.098455999506225619 1 0.026928702555088099 1 0.068076129562189724 
		1 0.069504500273068898 1;
	setAttr -s 13 ".kiy[0:12]"  0.96433846872496698 -0.105927599271678 
		0 0.99925963337574275 0 -0.99514140510845484 0 0.99963735673428078 0 -0.99768012939209738 
		0 0.99758163798347399 0;
	setAttr -s 13 ".kox[0:12]"  0.53395296356302258 0.17666300030956059 
		1 0.038473173845893278 1 0.098455999506225619 1 0.026928702555088099 1 0.068076129562189711 
		1 0.069504500273068898 1;
	setAttr -s 13 ".koy[0:12]"  0.84551418243709275 -0.98427139769558691 
		0 0.99925963337574275 0 -0.99514140510845484 0 0.99963735673428078 0 -0.99768012939209727 
		0 0.99758163798347399 0;
createNode animCurveTL -n "basicBall_ac_cn_top_translateY";
	rename -uid "404631ED-4030-BEF0-DD46-16A35E4A4DD9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0 7 0.73706698943785942 8 -0.43982745099318699
		 9 0.38592942922503948 12 0 15 0.73991288336739625 16 -0.44624532974286346 17 0.70198915706822662
		 19 0 22 0.59814525940874774 23 -0.057579865184306578 24 0;
	setAttr -s 12 ".kit[0:11]"  1 18 1 18 18 18 18 18 
		18 18 18 18;
	setAttr -s 12 ".kot[0:11]"  1 18 1 18 18 18 18 18 
		18 18 18 18;
	setAttr -s 12 ".kix[0:11]"  0.68405519484033528 1 0.21770853701749185 
		1 1 1 1 1 1 1 1 1;
	setAttr -s 12 ".kiy[0:11]"  0.72943025054624033 0 -0.97601382823692795 
		0 0 0 0 0 0 0 0 0;
	setAttr -s 12 ".kox[0:11]"  0.991771790333555 1 0.99677822311581676 
		1 1 1 1 1 1 1 1 1;
	setAttr -s 12 ".koy[0:11]"  -0.12801842015340983 0 -0.080207069028078476 
		0 0 0 0 0 0 0 0 0;
createNode animCurveTL -n "basicBall_ac_cn_top_translateZ";
	rename -uid "C5FE55DE-42E9-ACC6-8E63-8C94428940F9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
createNode animCurveTU -n "basicBall_ac_cn_top_twist";
	rename -uid "8AD90E26-4EF8-A24A-D43C-1FBBBAD52BE8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0;
select -ne :time1;
...
connectAttr "basicBall_ac_cn_base_type_ball.o" "basicsBall_rig_v0_1_betaRN.phl[2]"
		;
connectAttr "basicBall_ac_cn_base_translateY.o" "basicsBall_rig_v0_1_betaRN.phl[3]"
		;
connectAttr "basicBall_ac_cn_base_translateX.o" "basicsBall_rig_v0_1_betaRN.phl[4]"
		;
...
connectAttr "basicBall_ac_cn_base_rotateZ.o" "basicsBall_rig_v0_1_betaRN.phl[8]"
		;
connectAttr "basicBall_ac_cn_top_twist.o" "basicsBall_rig_v0_1_betaRN.phl[9]";
connectAttr "basicBall_ac_cn_top_translateX.o" "basicsBall_rig_v0_1_betaRN.phl[10]"
		;
connectAttr "basicBall_ac_cn_top_translateY.o" "basicsBall_rig_v0_1_betaRN.phl[11]"
		;
connectAttr "basicBall_ac_cn_top_translateZ.o" "basicsBall_rig_v0_1_betaRN.phl[12]"
		;
...
// End of Cliff_Ball_Bounce_Anim.ma
